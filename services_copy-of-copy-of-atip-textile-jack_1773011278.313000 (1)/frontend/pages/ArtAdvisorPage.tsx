    ...
    return (
        <div className="max-w-6xl mx-auto py-12 px-4">
            ...
            <div className="text-center mb-12">
                <h1 className="text-4xl font-aboreto text-title mb-2 animate-fade-in-down">{t('artAdvisor.title')}</h1>
                <p className="text-xl text-subtitle/90 font-playfair animate-fade-in-up animation-delay-300">{t('artAdvisor.subtitle')}</p>
            </div>

            <div className="max-w-3xl mx-auto bg-black-button/20 p-8 rounded-lg shadow-xl animate-fade-in-up animation-delay-500">
                <textarea
                    value={prompt}
            ...
            {hasSearched && !isLoading && (
                <div className="mt-16">
                    {error ? (
                        ...
                        <>
                            <h2 className="text-3xl font-aboreto text-title text-center mb-12 animate-fade-in-up">{t('artAdvisor.resultsTitle')}</h2>
